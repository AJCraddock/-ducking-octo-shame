define(
    ...
    function(MapLoader, PlayerController, PressAnythingController, ScriptController, ScriptButton){
        ...
        function Engine(){
            ...
            this.script_buttons.push(new ScriptButton(100, 551, "[z]: Move <<"));
            this.script_buttons.push(new ScriptButton(252, 551, "[x]: Standby"));
            this.script_buttons.push(new ScriptButton(404, 551, "[c]: Move >>"));
